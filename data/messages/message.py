...
blacklist_msg = """
<b>‼️Единый список скамеров, с которыми не стоит вести
сделки. Здесь вы можете проверить пользователя на наличие 
инцидентов скама за ним, или посмотреть весь 
список скамеров. </b>

Вы так-же можете внести скамера в наш список скамеров, нажав 
кнопку "🚫Внести скамера", тем самым помочь многим 
пользователям избежать скама. *Скамер внесется после 
одобрения вашей заявки администрацией.
"""
